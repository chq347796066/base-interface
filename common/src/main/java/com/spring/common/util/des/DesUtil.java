...
public class DesUtil {
	/** 加密工具     */
	 ...
	 /**
	  ...
	  {
		  DesUtil des = new DesUtil(keyList.get(num));
	  ...
	  {
		  DesUtil des = new DesUtil(keyList.get(i));
	   ...
	   * @author xsolr  
	   */
	  public static byte[] hexStr2ByteArr(String strIn) throws ServiceException {
	   ...
	   *             本方法不处理任何异常，所有异常全部抛出  
	   */
	  public static String byteArr2HexStr(byte[] arrB) throws ServiceException {
	    int iLen = arrB.length;
	   ...
	   * @throws Exception
	   */
	  private Key getKey(byte[] arrBtmp) throws ServiceException {
	    // 创建一个空的8位字节数组（默认值为0）   
