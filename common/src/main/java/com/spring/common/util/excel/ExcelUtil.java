...
/*import com.sunacwy.staff.common.annotation.Excel;
import com.sunacwy.staff.common.config.Global;
import com.sunacwy.staff.common.core.domain.R;
import com.sunacwy.staff.common.core.text.Convert;
import com.sunacwy.staff.common.exception.BusinessException;
import com.sunacwy.staff.common.utils.DateUtils;
import com.sunacwy.staff.common.utils.StringUtils;
import com.sunacwy.staff.common.utils.ToolUtil;
import com.sunacwy.staff.common.utils.reflect.ReflectUtils;*/
import com.spring.common.constants.MessageCode;
import com.spring.common.exception.BusinessException;
import com.spring.common.response.R;
import com.spring.common.util.ToolUtil;
import com.spring.common.util.date.DateToolUtils;
import com.spring.common.util.reflect.ReflectUtils;
import com.spring.common.util.string.StringUtils;
import com.spring.common.util.text.Convert;
            ...
            for (int i = 1; i < rows; i++)
            {
                ...
                for (int column = 0; column < cellNum; column++)
                {
                    ...
                    else if (Date.class == fieldType)
                    {
                        ...
                        {
                            val = DateToolUtils.parseDate(val);
                        }
            ...
            for (int j = 0; j < fields.size(); j++)
            {
                ...
                try
                {
                    ...
                    if (attr.isExport())
                    {
                        ...
                        {
                            cell.setCellValue(DateToolUtils.parseDateToStr(dateFormat, (Date) value));
                        }
