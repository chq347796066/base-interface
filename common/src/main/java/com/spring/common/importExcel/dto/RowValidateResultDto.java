...
public class RowValidateResultDto extends ValidateResultDto implements
	...
	public void setCvrDtoList(List<CellValidateResultDto> cvrDtoList) {
		this.cvrDtoList = cvrDtoList;
	}
	...
	public String toCurrRowmarkerErrMsg(){
		
		if (CollectionUtils.isEmpty(cvrDtoList)) {
			return "";
		}
		
		StringBuffer buffer = new StringBuffer();
		for (CellValidateResultDto cellValidateResultDto  : cvrDtoList) {
			buffer.append(cellValidateResultDto.getErrorMsg()).append("<br/>");
		}
