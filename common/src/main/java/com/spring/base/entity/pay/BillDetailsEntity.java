...
@TableName("p_bill_details")
public class BillDetailsEntity extends BaseEntity implements Vo<String>, Serializable {
   ...
   private Integer status;
    ...
    //账单总表
    @ApiModelProperty(value = "账单总表")
    @TableField(exist = false)
   private PayBillsEntity payBillsEntity;
