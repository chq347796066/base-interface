...
@TableName("p_trans_journals")
public class TransJournalsEntity extends BaseEntity implements Vo<String>, Serializable {
   ...
   private String roomNo;
    ...
    private TranspayJournalsEntity transpayJournalsEntity;

    private List<BusinessJournalsEntity> businessJournalsEntities;

    private List<BusinessExtendEntity> businessExtendEntities;
