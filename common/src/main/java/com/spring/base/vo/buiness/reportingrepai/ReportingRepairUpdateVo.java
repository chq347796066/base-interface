...
import com.spring.base.vo.buiness.repairpersonnel.RepairPersonnelVo;
...
@Data
@ToString
public class ReportingRepairUpdateVo {
	...
	private String tenantId;
	 ...
	 List<RepairPersonnelVo> personnelAddVoList;

	//维修人员上传图片
	@ApiModelProperty(value = "维修报修图片)")
