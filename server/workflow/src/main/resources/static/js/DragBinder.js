//千一网络 www.cftea.com
//DragBinder v1.0 MIT
//http://www.cftea.com/products/webComponents/DragBinder/
//需要 EZJ v1.0
//此文件为 UTF-8 格式
//应用示例：
/*
...
function DragBinder(target, controller)
{
    ...
    this.doDrag = function ()
    {
        ...
        var preDeltaX = (this.stepX > 0) ? preX - this.target.offsetLeft : 0;
        var preDeltaY = (this.stepY > 0) ? preY - this.target.offsetTop : 0;
        ...
        //移动
        this.target.style.left = (this.target.offsetLeft + info.deltaX) + "px";
        this.target.style.top = (this.target.offsetTop + info.deltaY) + "px";
...
{
    this.scopeElement = $obj(scopeElement);
