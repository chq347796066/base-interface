package com.spring.workflow.activiti.listener.acceptmain;
...
/**
 * @description:结题总部生产部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:33
 */
@Service()
@Slf4j
public class AcceptMainProductionListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptProductionTaskListener begin businessId:" + businessId + ",nodeId:pvmProductionAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvmProductionAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptProductionTaskListener businessId:" + businessId + ",nodeId:pvmProductionAuditLine,businessType:"
