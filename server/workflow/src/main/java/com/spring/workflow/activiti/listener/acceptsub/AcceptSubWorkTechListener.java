...
/**
 * @description:结题子公司工艺部审核
 * @author: 赵进华
 * @time: 2019/12/22 14:16
 */
@Service()
@Slf4j
public class AcceptSubWorkTechListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptSubWorkTechListener begin businessId:" + businessId + ",nodeId:pvsMainWorkAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvsMainWorkAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptSubWorkTechListener businessId:" + businessId + ",nodeId:pvsMainWorkAuditLine,businessType:"
