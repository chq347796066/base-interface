...
/**
 * @description:结题总公司自动化审核监听
 * @author: 赵进华
 * @time: 2019/12/22 14:06
 */
@Service()
@Slf4j
public class AcceptMainAutoListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptMainAutoListener begin businessId:" + businessId + ",nodeId:pvmAutoAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvmAutoAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptMainAutoListener businessId:" + businessId + ",nodeId:pvmAutoAuditLine,businessType:"
