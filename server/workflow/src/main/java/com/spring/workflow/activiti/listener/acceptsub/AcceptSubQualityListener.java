...
/**
 * @description:结题子公司品质部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:46
 */
@Service()
@Slf4j
public class AcceptSubQualityListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptSubQualityListener begin businessId:" + businessId + ",nodeId:pvsSubQualityAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvsSubQualityAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptSubQualityListener businessId:" + businessId + ",nodeId:pvsSubQualityAuditLine,businessType:"
