package com.spring.workflow.activiti.listener.sub;
 ...
 * @Desc类说明: 项目立项分厂生产审核连线监听器
 */
@Service()
@Slf4j
public class SubProductionTaskListener implements TaskListener, JavaDelegate {
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		log.info("SubProductionTaskListener begin businessId:" + businessId + ",nodeId:pcmAutoAuditLine,businessType:"
				+ businessType);
		...
		params.put("nodeId", "pcsProductAuditLine");
		// 调用存储过程动态获取审核用户列表
		...
		log.info("SubProductionTaskListener businessId:" + businessId + ",nodeId:pcsProductAuditLine,businessType:"
