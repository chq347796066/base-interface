 ...
 * @Desc类说明: 项目立项分厂质控审核连线监听器
 */
@Service()
@Slf4j
public class SubQualityTaskListener implements TaskListener, JavaDelegate {
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		log.info("SubQualityTaskListener begin businessId:" + businessId + ",nodeId:pcmAutoAuditLine,businessType:"
				+ businessType);
		...
		params.put("nodeId", "pcsQualityAuditLine");
		// 调用存储过程动态获取审核用户列表
		...
		log.info("SubQualityTaskListener businessId:" + businessId + ",nodeId:pcsQualityAuditLine,businessType:"
