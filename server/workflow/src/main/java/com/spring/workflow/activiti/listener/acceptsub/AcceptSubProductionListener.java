...
/**
 * @description:结题子公司生产部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:47
 */
@Service()
@Slf4j
public class AcceptSubProductionListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptSubProductionListener begin businessId:" + businessId + ",nodeId:pvsSubProductionAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvsSubProductionAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptSubProductionListener businessId:" + businessId + ",nodeId:pvsSubProductionAuditLine,businessType:"
