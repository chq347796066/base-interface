...
import com.spring.workflow.common.Result;
    ...
    public Result<List<Map<String,Object>>> listActivities(@PathVariable String proDefId) {
        ...
        if(model != null) {
            ...
            for(FlowElement e : flowElements) {
                ...
                if ("class org.activiti.bpmn.model.StartEvent".equalsIgnoreCase(e.getClass().toString()) ||
                        "class org.activiti.bpmn.model.UserTask".equalsIgnoreCase(e.getClass().toString())){
                    Map<String,Object> element = new HashMap<String, Object>(16);
