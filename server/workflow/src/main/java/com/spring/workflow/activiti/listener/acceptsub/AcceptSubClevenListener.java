...
/**
 * @description:结题智能化办公室审核审核监听
 * @author: 赵进华
 * @time: 2019/12/22 14:25
 */
@Service()
@Slf4j
public class AcceptSubClevenListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptSubClevenListener begin businessId:" + businessId + ",nodeId:pvsEquipChiefAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvsEquipChiefAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptSubClevenListener businessId:" + businessId + ",nodeId:pvsEquipChiefAuditLine,businessType:"
