...
/**
 * @description:结题总部质控部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:32
 */
@Service()
@Slf4j
public class AcceptMainQualityListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptQualityTaskListener begin businessId:" + businessId + ",nodeId:pvmQualityAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvmQualityAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptQualityTaskListener businessId:" + businessId + ",nodeId:pvmQualityAuditLine,businessType:"
