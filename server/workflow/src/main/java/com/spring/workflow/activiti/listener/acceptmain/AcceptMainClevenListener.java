...
/**
 * @description:结题总公司智能化办公室领导审核
 * @author: 赵进华
 * @time: 2019/12/22 14:11
 */
@Service()
@Slf4j
public class AcceptMainClevenListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptMainClevenListener begin businessId:" + businessId + ",nodeId:pvmEquipChiefAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvmEquipChiefAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptMainClevenListener businessId:" + businessId + ",nodeId:pvmEquipChiefAuditLine,businessType:"
