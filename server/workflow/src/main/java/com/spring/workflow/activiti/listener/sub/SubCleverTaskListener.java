 ...
 * @Desc类说明: 项目立项分厂智能化领导审核连线监听器
 */
@Service()
@Slf4j
public class SubCleverTaskListener implements TaskListener, JavaDelegate {
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		log.info("SubCleverTaskListener begin businessId:" + businessId + ",nodeId:pcmAutoAuditLine,businessType:"
				+ businessType);
		...
		params.put("nodeId", "pcsCleverAuditLine");
		// 调用存储过程动态获取审核用户列表
		...
		log.info("SubCleverTaskListener businessId:" + businessId + ",nodeId:pcsCleverAuditLine,businessType:"
