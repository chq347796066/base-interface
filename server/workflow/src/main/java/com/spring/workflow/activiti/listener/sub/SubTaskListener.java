 ...
 * @Desc类说明: 项目立项分厂人力资源审核连线监听器
 */
@Service()
@Slf4j
public class SubTaskListener implements TaskListener, JavaDelegate {
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		log.info("SubHRTaskListener begin businessId:" + businessId + ",nodeId:pcmAutoAuditLine,businessType:"
				+ businessType);
		...
		params.put("nodeId", "pcsHRAuditLine");
		// 调用存储过程动态获取审核用户列表
		...
		log.info("SubHRTaskListener businessId:" + businessId + ",nodeId:pcsHRAuditLine,businessType:" + businessType
