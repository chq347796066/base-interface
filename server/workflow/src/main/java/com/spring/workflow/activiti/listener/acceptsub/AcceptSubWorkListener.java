...
/**
 * @description:结题子公司工艺部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:46
 */
@Service()
@Slf4j
public class AcceptSubWorkListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptSubWorkListener begin businessId:" + businessId + ",nodeId:pvsSubWorkAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvsSubWorkAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptSubWorkListener businessId:" + businessId + ",nodeId:pvsSubWorkAuditLine,businessType:"
