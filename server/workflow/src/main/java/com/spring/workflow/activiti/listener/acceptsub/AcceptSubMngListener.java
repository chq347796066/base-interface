...
/**
 * @description:结题子公司人力部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:46
 */
@Service()
@Slf4j
public class AcceptSubMngListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptSubMngListener begin businessId:" + businessId + ",nodeId:pvsSubMngAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvsSubMngAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptSubMngListener businessId:" + businessId + ",nodeId:pvsSubMngAuditLine,businessType:"
