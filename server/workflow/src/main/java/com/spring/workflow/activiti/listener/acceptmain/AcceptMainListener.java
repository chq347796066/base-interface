...
/**
 * @description:结题总部人力部专人审核
 * @author: 赵进华
 * @time: 2019/12/20 18:32
 */
@Service()
@Slf4j
public class AcceptMainListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptHRTaskListener begin businessId:" + businessId + ",nodeId:pvmHRAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvmHRAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptHRTaskListener businessId:" + businessId + ",nodeId:pvmHRAuditLine,businessType:"
