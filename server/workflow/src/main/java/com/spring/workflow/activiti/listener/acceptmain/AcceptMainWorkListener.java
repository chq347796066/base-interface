...
/**
 * @description:结题总公司工艺部审核
 * @author: 赵进华
 * @time: 2019/12/22 14:02
 */
@Service()
@Slf4j
public class AcceptMainWorkListener implements TaskListener, JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        log.info("AcceptWorkMainListener begin businessId:" + businessId + ",nodeId:pvmWorkAuditLine,businessType:"
                + businessType);
        ...
        params.put("nodeId", "pvmWorkAuditLine");
        // 调用存储过程动态获取审核用户列表
        ...
        log.info("AcceptWorkMainListener businessId:" + businessId + ",nodeId:pvmWorkAuditLine,businessType:"
