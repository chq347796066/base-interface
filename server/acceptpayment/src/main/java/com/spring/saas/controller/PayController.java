...
import com.spring.config.WechatAccountConfig;
...
public class PayController {
    ...
    public PayResponse minipay(@RequestParam(value = "code") String code){
        ...
        payRequest.setOrderId(System.currentTimeMillis() + String.valueOf(random.nextInt(900000) + 100000)+dateTime.toString("yyyymmdd")+ (random.nextInt(90000) + 10000));
